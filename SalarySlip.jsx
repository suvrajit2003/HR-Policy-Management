  ...
  const generateSlipHtml = (employeeData) => {
    ...
    return `
      <div style="font-family: Arial, Helvetica, sans-serif; color:#222; width:800px; padding:24px; box-sizing:border-box;">
        ...
        <div style="margin-bottom:20px;"><div style="font-size:13px; font-weight:700; margin-bottom:8px; color:#2e7d32;">Earnings Calculation Details</div><table style="width:100%; border-collapse:collapse;"><thead><tr><th style="text-align:left; padding:8px; border:1px solid #e8e8e8; background:#f1f8f3;">Component</th><th style="text-align:right; padding:8px; border:1px solid #e8e8e8; background:#f1f8f3;">Amount</th><th style="text-align:center; padding:8px; border:1px solid #e8e8e8; background:#f1f8f3;">Calculation</th></tr></thead><tbody>${proratedEarnings.length ? proratedEarnings.map(e => `<tr><td style="padding:8px; border:1px solid #eee;">${e.name}</td><td style="padding:8px; border:1px solid #eee; text-align:right;">${formatCurrency(e.amount)}</td><td style="padding:8px; border:1px solid #eee; text-align:center; font-size:11px; color:#555;">${e.calculation}</td></tr>`).join('') : `<tr><td colspan="3" style="padding:12px; border:1px solid #eee; text-align:center;">No earnings listed</td></tr>`}</tbody><tfoot><tr style="background:#f1f8f3;"><td style="padding:8px; border:1px solid #e8e8e8; font-weight:700;">Gross Earnings</td><td style="padding:8px; border:1px solid #e8e8e8; text-align:right; font-weight:700;">${formatCurrency(finalGrossSalary)}</td><td style="padding:8px; border:1px solid #e8e8e8;"></td></tr></tfoot></table></div>
        <div style="margin-bottom:20px;"><div style="font-size:13px; font-weight:700; margin-bottom:8px; color:#c62828;">Deductions Calculation Details</div><table style="width:100%; border-collapse:collapse;"><thead><tr><th style="text-align:left; padding:8px; border:1px solid #e8e8e8; background:#fff5f5;">Component</th><th style="text-align:right; padding:8px; border:1px solid #e8e8e8; background:#fff5f5;">Amount</th><th style="text-align:center; padding:8px; border:1px solid #e8e8e8; background:#fff5f5;">Calculation</th></tr></thead><tbody>${proratedDeductions.length ? proratedDeductions.map(d => `<tr><td style="padding:8px; border:1px solid #eee;">${d.name}</td><td style="padding:8px; border:1px solid #eee; text-align:right;">${formatCurrency(d.amount)}</td><td style="padding:8px; border:1px solid #eee; text-align:center; font-size:11px; color:#555;">${d.calculation}</td></tr>`).join('') : ''}${ employeeData.unpaidLeaves > 0 ? `<tr><td style="padding:8px; border:1px solid #eee;">Unpaid Leave Deduction (${employeeData.unpaidLeaves} days)</td><td style="padding:8px; border:1px solid #eee; text-align:right;">${formatCurrency(leaveDeduction)}</td><td style="padding:8px; border:1px solid #eee; text-align:center; font-size:11px; color:#555;">Leave deduction based on policy</td></tr>` : '' }${(proratedDeductions.length === 0 && employeeData.unpaidLeaves === 0) ? `<tr><td colspan="3" style="padding:12px; border:1px solid #eee; text-align:center;">No deductions listed</td></tr>` : ''}</tbody><tfoot><tr style="background:#fff5f5;"><td style="padding:8px; border:1px solid #e8e8e8; font-weight:700;">Total Deductions</td><td style="padding:8px; border:1px solid #e8e8e8; text-align:right; font-weight:700;">${formatCurrency(finalTotalDeductions)}</td><td style="padding:8px; border:1px solid #e8e8e8;"></td></tr></tfoot></table></div>
