              ...
              {rows.map((row, idx) => {
                ...
                return (
                  <tr key={idx}>
                    ...
                    <td><span className="fw-bold">{row.component}</span>{compPolicy?.calculateDays !== undefined && (<div className="text-muted small">(Prorata: {compPolicy.calculateDays ? 'Yes' : 'No'})</div>)}</td>
                    <td>
